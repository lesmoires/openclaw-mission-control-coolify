...
const nextConfig: NextConfig = {
  // Produce a self-contained build for Docker deployments.
  // The standalone output copies only the files needed to run in production,
  // resulting in much smaller Docker images (no full node_modules).
  output: "standalone",
